        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center justify-end flex-1">
            <div className="hidden sm:flex sm:space-x-8">
              <Link href="/userDashboardGroup/registerItem" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-md font-medium text-black hover:text-gray-500">
                <Send className="mr-2 h-4 w-4" />
                Register an item
              </Link>
              <Link href="/userDashboardGroup/postFlight" className="mr-6 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-md font-medium text-black hover:text-gray-500">
      ...
      {isMobileMenuOpen && (
        <div className="sm:hidden">
          <div className="pt-2 pb-3 space-y-1">
            <Link href="/userDashboardGroup/registerItem" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700">
              Register An Item
            </Link>
            <Link href="/userDashboardGroup/postFlight" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700">
              Post a Flight
            </Link>
